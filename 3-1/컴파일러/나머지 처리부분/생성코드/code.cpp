...
void parseCompUnit() {
	...
	while((Token_list[curpos].Token == "INTTK" && Token_list[curpos + 2].Token == "LPARENT") || (Token_list[curpos].Token == "CHARTK" && Token_list[curpos + 2].Token == "LPARENT") || (Token_list[curpos].Token == "VOIDTK" && Token_list[curpos + 2].Token == "LPARENT")){
		parseFuncDef();
	} 
