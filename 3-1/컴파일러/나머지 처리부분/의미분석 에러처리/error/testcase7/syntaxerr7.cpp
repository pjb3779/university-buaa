...
//		if(curFunc.paramkind[param_num - 1] == 3){//기대값이 배열일떄  
//			
//			nextToken();//배열을 단일로 받는경우처리 
//			if(curToken.word == "["){
//				nextToken();
...
//		print_top++;
//	
//		if(curFunc.paramkind[param_num - 1] == 3){//함수 매개변수 타입으로 변경해야함 
//			push_err_list('e', last_func_line);
//		} 
