 ...
 *
 *  If the function encounters an error it should NOT exit,
 *  but process the entire file and return -1. If no errors were encountered,
 *  it should return 0.
 *
 * Parameters:
 ...
 *
 * Returns: int
 *  0 if no errors were encountered, -1 otherwise
 */
...
int open_files(FILE **input, FILE **output, const char *input_name,
